/*
 * TFT_Display class inherits from Adafruit_GFX class and the Arduino Print class.
...
class TFT_Display : public Adafruit_TFTLCD {
  public:
    TFT_Display(uint8_t CS=A3, uint8_t RS=A2, uint8_t WR=A1, uint8_t RD=A0, uint8_t _RST=0);  //dummy arguments
 //   TFT_Display(void);
